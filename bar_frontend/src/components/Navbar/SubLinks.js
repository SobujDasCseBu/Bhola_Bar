...
const SubLinks = ({ navItem, setOpenNav }) => {
  return (
    <li className="group relative inline-block block antialiased font-sans text-white text-lg font-semibold nav-item-primary nav-item-dropdown">
      <button className="inline-flex items-center flex items-center ease-linear transition-all duration-150 h-full">
