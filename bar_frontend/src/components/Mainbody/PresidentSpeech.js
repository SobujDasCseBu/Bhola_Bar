...
import pic2 from "../../assets/images/president_20221001013039.jpg";
import pic from '../../assets/images/committee/president.jpg'
...
const PresidentSpeech = ({ committeeItem, designation }) => {
  return (
    <Card className="w-[100%]  flex items-center shadow-2xl border  divide-solid  border-gray-100 mb-[30px]">
      ...
      <CardBody className="text-center">
        ...
        <Typography
          variant="h5"
          color="blue"
          className="font-medium text-[#F42A41] "
          textGradient
        >
          {designation}
        </Typography>
        <p className="text-[16px] p-0 m-0 text-left"></p>

        <div className="flex justify-center mt-4">
          <button
            type="submit"
            className=" px-4 py-2 ml-4 text-xs font-bold tracking-widest hover:bg-[#d39b36] cursor-pointer transition duration-300 text-white  bg-[#F42A41] border border-transparent rounded-[18px] active:bg-[#006A4E] false"
          >
            Read More
          </button>
        </div>
