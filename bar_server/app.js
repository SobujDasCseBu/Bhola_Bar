...
const noticeRouter = require("./src/routers/notice")
const newsRouter = require("./src/routers/news")
const committeeRouter = require("./src/routers/committee")
const galleryRouter = require("./src/routers/imageGallery")
const subCommitteeRouter = require("./src/routers/subCommittee")
const utilsRouter = require("./src/routers/utils")
...
app.use("/api/v1/sub-committee", subCommitteeRouter)
